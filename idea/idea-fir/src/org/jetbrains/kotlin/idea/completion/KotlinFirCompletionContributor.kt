...
class KotlinFirCompletionContributor : CompletionContributor() {
    ...
    override fun beforeCompletion(context: CompletionInitializationContext) {
        ...
        context.dummyIdentifier = service<CompletionDummyIdentifierProviderService>().providerDummyIdentifier(context)
    }
}
...
private object KotlinFirCompletionProvider : CompletionProvider<CompletionParameters>() {
    ...
    private fun KtAnalysisSession.complete(
        ...
        val classifierNameContributor = FirClassifierNameCompletionContributor(basicContext)
