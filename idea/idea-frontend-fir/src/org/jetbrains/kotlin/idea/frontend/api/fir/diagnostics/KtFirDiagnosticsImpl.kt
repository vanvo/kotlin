...
internal class NoActualForExpectImpl(
    ...
    override val compatibility: Map<Incompatible<AbstractFirBasedSymbol<*>>, List<KtSymbol>>,
    firDiagnostic: FirPsiDiagnostic<*>,
    override val token: ValidityToken,
...
internal class NoActualClassMemberForExpectedClassImpl(
    override val declaration: KtSymbol,
    override val members: List<Pair<KtSymbol, Map<Incompatible<AbstractFirBasedSymbol<*>>, List<KtSymbol>>>>,
    firDiagnostic: FirPsiDiagnostic<*>,
    override val token: ValidityToken,
