...
import org.jetbrains.kotlin.test.runners.ir.AbstractIrTextTestBase

open class AbstractIrPartialInterpreterTest : AbstractIrTextTestBase(FrontendKinds.ClassicFrontend) {
    override fun configure(builder: TestConfigurationBuilder) {
        ...
        with(builder) {
            ...
            useArtifactsHandlers(::PhasedIrDumpHandler)
        }
    }
}
