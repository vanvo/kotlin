...
import org.jetbrains.kotlin.ir.interpreter.isTopLevelAccessor
...
class IrCompileTimeChecker(
    ...
    override fun visitGetField(expression: IrGetField, data: Nothing?): Boolean {
        ...
        fun isJavaPrimitiveStatic(): Boolean {
        ...
        return when {
            ...
            isJavaPrimitiveStatic() -> owner.initializer?.accept(this, data) == true
    ...
    override fun visitSetField(expression: IrSetField, data: Nothing?): Boolean {
        if (expression.isTopLevelAccessor()) return false
        //todo check receiver?
