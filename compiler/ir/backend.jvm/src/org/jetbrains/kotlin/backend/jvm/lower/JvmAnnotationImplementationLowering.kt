...
private val ANNOTATION_IMPLEMENTATION = object : IrDeclarationOriginImpl("ANNOTATION_IMPLEMENTATION", isSynthetic = true) {}
...
open class AnnotationImplementationLowering(val context: BackendContext) : FileLoweringPass, IrElementTransformerVoidWithContext() {
    ...
    override fun visitConstructorCall(expression: IrConstructorCall): IrExpression {
        ...
        val newCall = IrConstructorCallImpl.fromSymbolOwner(
            ...
            implClass.defaultType, // not sure if here should be impl type or original annotation type. This one won't work with generics
            ctor.symbol // we also need origin perhaps
        )
    ...
    private fun createAnnotationImplementation(annotationClass: IrClass): IrClass {
        ...
        val subclass = context.irFactory.buildClass {
            ...
            superTypes = listOf(annotationClass.defaultType) // + getAdditionalSupertypes(superType)
        }
