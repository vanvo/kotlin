...
object FirErrors {
    ...
    val NO_ACTUAL_FOR_EXPECT by error3<KtNamedDeclaration, AbstractFirBasedSymbol<*>, FirModuleData, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>(SourceElementPositioningStrategies.INCOMPATIBLE_DECLARATION)
    val ACTUAL_WITHOUT_EXPECT by error2<KtNamedDeclaration, AbstractFirBasedSymbol<*>, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>()
    val AMBIGUOUS_ACTUALS by error2<KtNamedDeclaration, AbstractFirBasedSymbol<*>, Collection<AbstractFirBasedSymbol<*>>>(SourceElementPositioningStrategies.INCOMPATIBLE_DECLARATION)
    val AMBIGUOUS_EXPECTS by error2<KtNamedDeclaration, AbstractFirBasedSymbol<*>, Collection<FirModuleData>>(SourceElementPositioningStrategies.INCOMPATIBLE_DECLARATION)
    val NO_ACTUAL_CLASS_MEMBER_FOR_EXPECTED_CLASS by error2<KtNamedDeclaration, AbstractFirBasedSymbol<*>, List<Pair<AbstractFirBasedSymbol<*>, Map<Incompatible<AbstractFirBasedSymbol<*>>, Collection<AbstractFirBasedSymbol<*>>>>>>(SourceElementPositioningStrategies.ACTUAL_DECLARATION_NAME)
