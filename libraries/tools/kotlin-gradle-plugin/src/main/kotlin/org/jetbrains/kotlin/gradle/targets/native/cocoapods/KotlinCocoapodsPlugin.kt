...
open class KotlinCocoapodsPlugin : Plugin<Project> {
    ...
    private fun createSyncTask(
        ...
        val platform = project.findProperty(PLATFORM_PROPERTY)?.toString() ?: return@whenEvaluated
        val archs = project.findProperty(ARCHS_PROPERTY)?.toString()?.split(" ") ?: return@whenEvaluated
